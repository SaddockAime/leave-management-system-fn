      ...
      try {
        ...
        if (data) {
          ...
          if (data.status !== 'PENDING') {
            ...
            navigation.push(`/dashboard/admin/leave-requests/${requestId}`);
            return;
          }
  ...
  if (!leaveRequest) {
    return (
      <div className="space-y-6">
        <Button
          variant="outline"
          onClick={() => navigation.push('/dashboard/admin/leave-requests')}
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              size="sm"
              onClick={() => navigation.push(`/dashboard/admin/leave-requests/${requestId}`)}
              className="cursor-pointer"
            >
          ...
          <p className="text-muted-foreground">
            Modify leave request for {leaveRequest.employee.user.firstName}{' '}
          ...
          <div className="flex gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-yellow-800 dark:text-yellow-200">
                Updating the leave request dates will recalculate the number of days and adjust the
                employee leave balance. The employee will be notified of any changes.
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Current leave request details (read-only)</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input value={`${leaveRequest.numberOfDays} days`} disabled className="bg-muted" />
                <p className="text-muted-foreground text-xs">
                  Will be recalculated based on new dates
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Update Leave Dates & Reason</CardTitle>
              <CardDescription>Modify the leave request details</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-xs">
                  Provide a clear reason for the leave request
                </p>
              </div>

              <div className="bg-muted rounded-md p-4">
                <h4 className="mb-2 text-sm font-medium">What happens when you save?</h4>
                <ul className="text-muted-foreground space-y-1 text-xs">
                  <li>• System will validate the new dates</li>
                  <li>• Business days will be recalculated</li>
                  <li>• Leave balance will be adjusted accordingly</li>
                  <li>• Employee will receive a notification</li>
                  <li>• Request remains in PENDING status</li>
                </ul>
              </div>
            </CardContent>
          </Card>
